!(function (a) {
  ...
  a.sessionTimeout = function (b) {
    function c() {
      n ||
        (a.ajax({ type: i.ajaxType, url: i.keepAliveUrl, data: i.ajaxData }),
        (n = !0),
        setTimeout(function () {
          n = !1;
        }, i.keepAliveInterval));
    ...
    function f(b, c) {
      clearTimeout(j.timer),
        ...
        i.countdownBar && "dialog" === b
          ? (j.percentLeft = Math.floor(
              (j.timeLeft / ((i.redirAfter - i.warnAfter) / 1e3)) * 100
            ))
          : i.countdownBar &&
            "session" === b &&
            (j.percentLeft = Math.floor(
      ...
      i.countdownBar && a(".countdown-bar").css("width", j.percentLeft + "%"),
        ...
        function (b) {
          ...
          d(),
            a("#session-timeout-dialog").length > 0 &&
              ...
              a("#session-timeout-dialog").data("bs.modal").isShown &&
