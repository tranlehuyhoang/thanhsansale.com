...
<div class="navbar-header">
    <div class="d-flex">
        ...
        <div class="navbar-brand-box">
            <a href="<?=ADMIN_PATH?>" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="<?=$setting->Logo?>" alt="" height="24">
                </span>
                <span class="logo-lg">
                    <img src="<?=$setting->Logo?>" alt="" height="24"> <span class="logo-txt">Portal</span>
                </span>
            </a>

            <a href="<?=ADMIN_PATH?>" class="logo logo-light">
                <span class="logo-sm">
                    <img src="<?=$setting->Logo?>" alt="" height="24">
                </span>
                <span class="logo-lg">
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button onclick="window.location.href='<?=ADMIN_PATH?>/setting'" type="button" class="btn header-item right-bar-toggle me-2">
