<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">Thêm Mới thông báo</div>
            <div class="card-body">
                <form method="post" action="<?=ADMIN_PATH?>/notification/create" class="row">
                    <div class="form-group col-6">
                        <label for="Title">Tiêu đề</label>
                        <input type="text" class="form-control" id="Title" name="Title" placeholder="Ví dụ: Thông báo về ...">
                    </div>
                    <div class="form-group col-6">
                        <label for="Image">Chọn loại thông báo</label>
                        <select class="form-control" id="Type" name="Type">
                            <option value="0">Thông báo All</option>
                            <option value="1">Thông báo cho user</option>
                        </select>
                    </div>
                    <!-- Chon user -->
                    <div class="form-group col-6">
